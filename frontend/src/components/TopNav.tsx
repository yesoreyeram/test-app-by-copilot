...
const TopNav: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white dark:bg-gray-800 gold:bg-gold-100 shadow-md">
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white gold:text-gold-900">
                Test App
              </span>
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <input
              type="search"
              placeholder="Search..."
              className="hidden md:block px-4 py-2 rounded-lg border dark:bg-gray-700 dark:border-gray-600 dark:text-white gold:bg-white gold:border-gold-300"
            />
            
            <select
              value={theme}
              onChange={(e) => setTheme(e.target.value as any)}
              className="px-3 py-1 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white gold:bg-white gold:border-gold-300"
            >
